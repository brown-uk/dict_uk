...
def findInDict(word) {
	...
	def ending = word.replaceFirst(/^(авіа|авто|агро|аеро|анти|аудіо|багато|відео|гео|гепато|геронто|геліо|гідро|гіпер|електро|за|кіно|мега|мета|мікро|мото|нейро|не|пере|під|по|проти|про|псевдо|радіо|стерео|спорт|теле|фото|супер|термо)/, '')
